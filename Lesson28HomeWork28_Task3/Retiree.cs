...
{
    public class Retiree : Сitizen
    {
        public Retiree(string FullName, string PasportInformation) :base(FullName,PasportInformation)
        {
        ...
        {
            return $"Полное имя пенсионера: {FullName}, {PasportInformation}";
        }
    }
}
