...
namespace Lesson28HomeWork28_Task3
{
    public class Program
    {
        ...
        {
            var collection = new UserCollection<object> { new Student("Tim Kurchenok", "HB1111111"), new Worker("Tim Kurchenok", "HB29239193"), new Retiree("Tim Kurchenok", "HB363353535"), new Retiree("Klimanskiy Pavel", "HB141142124") };
