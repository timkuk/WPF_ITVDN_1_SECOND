...
{
    public class Student : Сitizen
    {
        public Student(string FullName, string PasportInformation) : base(FullName, PasportInformation)
        {
        ...
        {
            return $"Полное имя студента: {FullName}, {PasportInformation}";
        }
    }
}
